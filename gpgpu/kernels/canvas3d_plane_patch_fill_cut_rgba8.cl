...
//
// Contract:
// - Stage1 affine plane patch fill: one 3D plane, up to four local half-space
//   cuts, one RGBA8/XRGB-style destination surface.
...
__kernel void canvas3d_plane_patch_fill_cut_rgba8(
